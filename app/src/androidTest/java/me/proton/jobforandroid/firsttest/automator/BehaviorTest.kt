...
class BehaviorTest {
    ...
    fun test_MainActivityIsStarted() {
        ...
        Assert.assertNotNull("EditText is null", editText)
    }
    ...
    fun test_SearchIsPositive() {
        ...
        Assert.assertNotNull("Changed text is null", changedText)
        if (changedText != null) {
    ...
    fun test_OpenDetailsScreen() {
        ...
        Assert.assertNotNull("toDetails button is null", toDetails)
        ...
        Assert.assertEquals("Number of results: 0", changedText?.text)
    }
